...
const val GEOFENCE_EXPIRATION = 21 * 24 * 60 * 60 * 1000 // 10 days
const val GEOFENCE_DWELL_DELAY =  21 * 24 * 60 * 60 * 1000 // 10 secs // 2 minutes
const val GEOFENCE_LOCATION_REQUEST_CODE = 12345
const val CAMERA_ZOOM_LEVEL = 13f
const val LOCATION_REQUEST_CODE = 123
private val TAG: String = MapsActivity::class.java.simpleName
val geofenceIdList = mutableListOf<Geofence>()
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun setLongClick(map: GoogleMap) {
        map.setOnMapLongClickListener { latlng ->
            ...
            map.addCircle(
                CircleOptions()
                    .center(latlng)
                        .strokeColor(0xFF3C4F76.toInt())
                    .fillColor(0xFFF4BB58.toInt())
    ...
    private fun createGeoFence(location: LatLng, key: String, geofencingClient: GeofencingClient) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            if (ContextCompat.checkSelfPermission(
                ...
                showToast(this, "Device location has been successfully set up")
            }
        } else {
            geofencingClient.addGeofences(geofenceRequest, pendingIntent)
            showToast(this, "Device location has been successfully set up")
    ...
    companion object {
        fun removeGeofences(context: Context, triggeringGeofenceList: MutableList<Geofence>?) {
            ...
            if (triggeringGeofenceList != null) {
                for (entry in triggeringGeofenceList) {
                    geofenceIdList.add(entry.toString())
                }
            }
    ...
    fun onRemoveGeofenceButtonClick(view: View) {
        // Call the removeGeofences function passing the necessary parameters
        removeGeofences(this, geofenceIdList)
    }
}